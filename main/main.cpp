...
MotorDC left_back_motor(ENCA_LEFT_BACK, ENCB_LEFT_BACK, L_EN_LEFT_BACK,
                        L_PWM_LEFT_BACK, R_PWM_LEFT_BACK, ledc_channel_t(2));
MotorDC right_front_motor(ENCA_RIGHT_FRONT, ENCB_RIGHT_FRONT, L_EN_RIGHT_FRONT,
                          L_PWM_RIGHT_FRONT, R_PWM_RIGHT_FRONT,
                          (ledc_channel_t)0);
