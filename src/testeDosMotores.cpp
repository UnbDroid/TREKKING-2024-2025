...
void setup() {
  ...
  ledcSetup(CANAL_RPWM_DIREITO_FRENTE,5000,8);
  ledcSetup(CANAL_LPWM_DIREITO_FRENTE,5000,8);
  ledcSetup(CANAL_RPWM_DIREITO_TRAS,5000,8);
  ledcSetup(CANAL_LPWM_DIREITO_TRAS,5000,8);


  ledcSetup(CANAL_RPWM_ESQUERDO_FRENTE,5000,8);
  ledcSetup(CANAL_LPWM_ESQUERDO_FRENTE,5000,8);
  ledcSetup(CANAL_RPWM_ESQUERDO_TRAS,5000,8);
  ledcSetup(CANAL_LPWM_ESQUERDO_TRAS,5000,8);
